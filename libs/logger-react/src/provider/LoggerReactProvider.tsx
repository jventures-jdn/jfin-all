...
export interface LoggerReactContextType {
    ...
    >
    addMessage: (message: string | ReactNode, color?: keyof typeof colorEnum) => void
...
export const LoggerReactContext = createContext<LoggerReactContextType>(defaultValues)
...
export function LoggerReactProvider({ children }: { children: ReactNode }) {
    ...
    /* --------------------------------- Methods -------------------------------- */
    const addMessage = (message: string | ReactNode, color?: keyof typeof colorEnum) => {
