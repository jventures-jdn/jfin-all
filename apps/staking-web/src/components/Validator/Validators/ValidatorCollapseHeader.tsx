...
const ValidatorCollapseHeader = observer(({ validator }: IValidatorCollapseHeader) => {
    /* -------------------------------------------------------------------------- */
    /*                                   States                                   */
    /* -------------------------------------------------------------------------- */
        ...
        <Row className="validator-collapse-header">
            ...
            <Col className="item-brand" lg={5} sm={7} xs={14}>
                ...
                <img
                    ...
                    src={`${
                        VALIDATOR_WALLETS[validator.owner as Address]?.image || defaultValidatorImg
                    }`}
                />
                ...
                <b>
                    ...
                    <CopyToClipboard text={validator.owner as Address}>
                        <CopyOutlined className="copy-clipboard" style={{ marginLeft: '5px' }} />
                    </CopyToClipboard>

                    {/* validator status */}
                    <Tooltip placement="right" title={getValidatorStatus(validator.status).status}>
                        <div
