        ...
        render: (log: StakingHistoryLog) => {
            return (
                <div className="items-center column-validator">
                    <img
                        src={VALIDATOR_WALLETS[log.args.validator as string]?.image || defaultImage}
                        alt={
        ...
        render: (log: StakingHistoryLog) => {
            return (
                <a
                    ...
                    rel="noreferrer"
                >
                    {[log.transactionHash.slice(0, 5), log.transactionHash.slice(-5)].join('....')}
                </a>
            )
        },
    },
    ...
    return (
        <div className="staking-history-container">
            <Table
                ...
                loading={loading}
                dataSource={
                    EXPECT_CHAIN.chainId === chain?.id ? chainStaking.myStakingHistoryLogs : []
