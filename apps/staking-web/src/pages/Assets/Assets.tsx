import { LoadingOutlined, ClockCircleOutlined, WalletOutlined } from '@ant-design/icons'
...
const Assets = observer(() => {
    ...
    const isLoading = loading || chainStaking.isFetchingValidators || !chainStaking.isReady
